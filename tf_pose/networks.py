...
def _get_base_path():
    if not os.environ.get('OPENPOSE_MODEL', ''):
        if os.path.exists('models'):
            ...
            return os.path.abspath(os.path.join(os.path.pardir, 'models'))
        return os.path.abspath('models')
...
def get_graph_path(model_name):
    dyn_graph_path = {
        ...
        #'mobilenet_thin': 'graph/mobilenet_thin/graph_freeze.pb',
        'mobilenet_thin_banisters_v1': 'graph/mobilenet_thin_banisters_v1/output_graph.pb'
    }
